...
#define z(p, q) vxorf(B[p]       , _local_K[q])
...
__kernel void DES_bs_25_self_test(__global DES_bs_transfer *DES_bs_all,
...
__kernel void DES_bs_25_mm(__global DES_bs_vector *B_global,
			__global int *binary,
			  int num_loaded_hash,
