...
/* All Ranges are non-consecutive */
__kernel void md4_nnn(__global const uint *keys,
		  __global const ulong *index,
		  __global uint *loaded_hashes,
		  __global uint *outKeyIdx,
		  __global struct bitmap_context_mixed *bitmap1,
...
/* One Range is consective */
__kernel void md4_cnn(__global const uint *keys,
		  __global const ulong *index,
		  __global uint *loaded_hashes,
		  __global uint *outKeyIdx,
		  __global struct bitmap_context_mixed *bitmap1,
...
__kernel void md4_ccc(__global const uint *keys,
		  __global const ulong *index,
		  __global uint *loaded_hashes,
		  __global uint *outKeyIdx,
		  __global struct bitmap_context_mixed *bitmap1,
