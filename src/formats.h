...
/* Number of keys generated internally by the format per key generated by host.   */
/* Mask mode will use this parameter for allocating ranges to a format which will */
/* be iterated internally by the format. The actual number of keys that will be   */
/* generated by the format internally will depend on the ranges returned by mask  */
/* mode.									  */
	int num_internal_keys;
